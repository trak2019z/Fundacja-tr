...
class PetInfoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('dataUrodzeniaZwierzaka', DateType::class, array(
                'label' => 'Wybierz datę urodzenia zwierzaka',
                'format' => 'ddMMyyyy',
                'years' => range($datePocz, $dateKon)
            ))
            ...
            ->add('dataAdopcji', DateType::class, array(
                'label' => 'Wybierz datę adopcji',
                'format' => 'ddMMyyyy',
                'years' => range($datePocz, $dateKon)
            ))
            ->add('dataSmierci', DateType::class, array(
                'label' => 'Wybierz datę śmierci',
                'format' => 'ddMMyyyy',
                'years' => range($datePocz, $dateKon)
            ));
    }
