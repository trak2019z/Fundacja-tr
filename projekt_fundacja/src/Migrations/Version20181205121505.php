 ...
 */
final class Version20181205121505 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE workers CHANGE worker_id worker_id INT AUTO_INCREMENT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE workers CHANGE worker_id worker_id INT NOT NULL');
    }
}
